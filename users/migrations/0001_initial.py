    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.ManyToManyField(blank=True, help_text='The roles this user belongs to. A user will get all permissions granted to each of their roles.', related_name='custom_users', related_query_name='custom_user', to='users.role', verbose_name='role')),
            ],
            managers=[
